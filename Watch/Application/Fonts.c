...
#define PRINTABLE_CHARACTERS ( 128 )
...
unsigned char MapCharacterToIndex(unsigned char CharIn)
{
  ...
  default : 
    ...
    else if ( (CharIn >= 0xC0) && (CharIn < 0xFF) )
    {
      Result = CharIn - 0x60;
    }
...
const unsigned char MetaWatch7table[PRINTABLE_CHARACTERS][7] = 
{
  ...
  //ё
  //4
  0x05, 0x07, 0x01, 0x07, 0x01, 0x07, 0x00, 



  /* character 0x ('А'): (width=4) */
  0x02, 0x02, 0x05, 0x05, 0x07, 0x05, 0x00, 
  
  /* character 0x42 ('Б'): (width=5) */
  0x07, 0x01, 0x07, 0x09, 0x09, 0x07, 0x00, 

  /* character 0x42 ('В'): (width=5) */
  0x07, 0x09, 0x07, 0x09, 0x09, 0x07, 0x00, 

  /* character 0x42 ('Г'): (width=3) */
  0x07, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00, 
  
  
  
  //д 5
  0x04, 0x0A, 0x0A, 0x0A, 0x11, 0x1F, 0x11, 
  
  
  
  //е 4
  0x07, 0x01, 0x07, 0x01, 0x01, 0x07, 0x00, 
 
   
  //ж
  //7
  0x2A, 0x2A, 0x1C, 0x2A, 0x2A, 0x49, 0x00, 
  
  //з
  //5
  0x06, 0x09, 0x04, 0x08, 0x09, 0x06, 0x00, 


  ////и
  //5
  0x09, 0x0D, 0x0D, 0x0B, 0x0B, 0x09, 0x00, 
  
  //й
  //5
  0x05, 0x02, 0x09, 0x0D, 0x0B, 0x09, 0x00, 
  
  //к
  //5
  0x09, 0x05, 0x03, 0x05, 0x05, 0x09, 0x00, 
  
  //л
  //4
  0x02, 0x02, 0x05, 0x05, 0x05, 0x05, 0x00, 
 
  //м
  //6
  0x11, 0x1B, 0x1B, 0x15, 0x15, 0x15, 0x00, 
  ...
  //п5
  0x0F, 0x09, 0x09, 0x09, 0x09, 0x09, 0x00, 
  
  //р4
  0x03, 0x05, 0x05, 0x03, 0x01, 0x01, 0x00, 
  
  //с5
  0x06, 0x09, 0x01, 0x01, 0x09, 0x06, 0x00, 
  
  //т3
  0x07, 0x02, 0x02, 0x02, 0x02, 0x02, 0x00, 
  
  //у4
  0x09, 0x09, 0x06, 0x06, 0x04, 0x03, 0x00, 
  
  //ф6
  0x04, 0x0E, 0x15, 0x15, 0x0E, 0x04, 0x00, 

  //х4
  0x05, 0x05, 0x02, 0x02, 0x05, 0x05, 0x00, 
  
  //ц5
  0x09, 0x09, 0x09, 0x09, 0x09, 0x1F, 0x10, 
  
  //ч5
  0x09, 0x09, 0x09, 0x0E, 0x08, 0x08, 0x00, 
  
  //ш6
  0x15, 0x15, 0x15, 0x15, 0x15, 0x1F, 0x00, 
  
  //щ6
  0x15, 0x15, 0x15, 0x15, 0x15, 0x3F, 0x20, 

  //ъ5
  0x03, 0x02, 0x06, 0x0A, 0x0A, 0x06, 0x00, 

  //ы6
  0x11, 0x11, 0x13, 0x15, 0x15, 0x13, 0x00, 
  
  //ь5
  0x01, 0x01, 0x07, 0x09, 0x09, 0x07, 0x00, 

  //э5
  0x07, 0x08, 0x0E, 0x08, 0x09, 0x06, 0x00, 
  
  //ю7
  0x19, 0x25, 0x27, 0x25, 0x25, 0x19, 0x00, 
  
  //я5
  0x0E, 0x09, 0x09, 0x0E, 0x0A, 0x09, 0x00
