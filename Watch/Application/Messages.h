...
#define MODIFY_TIME_INCREMENT_CORR   ( 0x03 )
#define MODIFY_TIME_DECREMENT_CORR   ( 0x04 )



#define MENU_MODE_OPTION_MAIN_PAGE           ( 0x01 )
#define MENU_MODE_OPTION_SETTINGS_PAGE       ( 0x02 )
//#define MENU_MODE_OPTION_PAGE3             ( 0x03 )
#define MENU_MODE_OPTION_PAGE_ALARM_SETTINGS ( 0x10 ) // Настройки будильника
#define MENU_MODE_OPTION_PAGE_TIME_SETTINGS  ( 0x11 ) // Настройки времени
...
#define MENU_BUTTON_OPTION_ALAM_ON_OFF                  ( 0x20 )
#define MENU_BUTTON_OPTION_ALAM_MIN_PLUS                ( 0x21 )
#define MENU_BUTTON_OPTION_ALAM_HOUR_PLUS               ( 0x22 )
#define MENU_BUTTON_OPTION_ALAM_NEXT_ALARM              ( 0x23 )
...
/****Calendar******************************************************************/
#define CALENDAR_MONTH_PLUS       ( 1 )
#define CALENDAR_MONTH_MINUS      ( 2 )
#define CALENDAR_EDIT             ( 3 )
/******************************************************************************/
typedef struct
{
