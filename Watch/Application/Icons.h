...
extern const unsigned char pNumIcon[32*3];
extern const unsigned char pMinusIcon[32*3];
extern const unsigned char pPlusIcon[32*3];
...
extern const unsigned char pMinHourSwitchIcon[32*6];
extern const unsigned char pAlarmIcon[32*6];
extern const unsigned char pAlarmOffIcon[32*6];
extern const unsigned char pAlarmOnIcon[32*6];
extern const unsigned char pSettingsIcon[32*6];
extern const unsigned char pDiaryIcon[32*6];
extern const unsigned char pTimeIcon[32*6];
