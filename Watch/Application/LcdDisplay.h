...
#define WATCH_DRAWN_IDLE_BUFFER_ROWS  ( 40 ) //30
#define WATCH_DRAWN_IDLE_AND_DATE_BUFFER_ROWS  ( 40 )
#define PHONE_IDLE_BUFFER_ROWS        ( 56 ) //66
#define PHONE_FULL_BUFFER_ROWS        ( 96 ) 
